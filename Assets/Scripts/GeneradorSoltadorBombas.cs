...
public class GeneradorSoltadorBombas : MonoBehaviour
{
    ...
    if (numeroAleatorio >= delimitadorRandom) {
            ...
            Debug.Log("[INFO/DEBUG]: " + listaPrefabs[indiceAleatorio].gameObject.name + " fue generado");
    ...
    void OnBecameVisible() {
        ...
        Debug.Log("El generador ha entrado en distancia de renderizando. Activando...");
        bucleGeneracionBomba();
    ...
    void OnBecameInvisible() {
        ...
        Debug.Log("El generador ha salido de la distancia de renderizado. Desactivando...");
        cancelarGeneracion();
